            ...
            <>
                {filteredExercises.slice(0, displayCount).map(ex => (
                    <motion.div
                      key={ex.id}
                      whileTap={{ scale: 0.98 }}
                      className="bg-slate-900/40 backdrop-blur-sm border border-slate-800/50 p-2.5 rounded-3xl flex items-center gap-3 cursor-pointer hover:border-purple-500/30 transition-all group"
                    ...
                    >
                      ...
                      <div className="w-8 h-8 rounded-xl bg-slate-950 text-slate-700 flex items-center justify-center border border-slate-800 group-hover:text-purple-500 group-hover:border-purple-500/30 transition-all">
